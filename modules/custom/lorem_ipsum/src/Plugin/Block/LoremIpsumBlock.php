...
namespace Drupal\lorem_ipsum\Plugin\Block;
...
class LoremIpsumBlock extends BlockBase 
{
  ...
  public function build() 
  {
    ...
    return \Drupal::formBuilder()->getForm('Drupal\lorem_ipsum\Form\LoremIpsumBlockForm');
  }
  ...
  public function blockSubmit($form, FormStateInterface $form_state) {
    $this->setConfigurationValue('loremipsum_block_settings', 
